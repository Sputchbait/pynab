"""
Serialize & unserialize RFID application data for MQTT Bridge
"""
import json
...
def serialize(data):
    """
    Serialize RFID data for MQTT Bridge.
    Store event name as UTF-8 encoded string.
    """
...
def unserialize(data):
    """
    Unserialize RFID data for MQTT Bridge.
    Decode event name from UTF-8 encoded bytes.
    """
    try:
